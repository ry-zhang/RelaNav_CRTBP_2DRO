...
% u1_x=1-(1-mu)*(1/(r1^3)-3*((x(1)+1)^2)/(r1^5))-mu*(1/(r2^3)-3*((x(1))^2)/(r2^5));

u1_x=-(1-mu)*(1/(r1^3)-3*((x(1)+1)^2)/(r1^5))-mu*(1/(r2^3)-3*((x(1))^2)/(r2^5));

u1_y=3*(1-mu)*x(2)*(x(1)+1)/r1^5+3*mu*x(2)*x(1)/r2^5;

u1_z=3*(1-mu)*x(3)*(x(1)+1)/r1^5+3*mu*x(3)*x(1)/r2^5;

u2_x=u1_y;

u2_y=-(1-mu)*(1/(r1)^3-3*x(2)^2/r1^5)-mu*(1/r2^3-3*x(2)^2/r2^5);

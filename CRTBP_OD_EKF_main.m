...
% [structRss, structState, distance] = CRTBP_OD_EKF_func(P0, Yerr, SC1, SC2, rm, simdur, simstep,sigma_range, bias_range);%CRTBP相对状态估计EKF
[structRss, structState, distance] = CRTBP_OD_AF_func(P0, Yerr, SC1, SC2, rm, simdur, simstep,sigma_range, bias_range);%CRTBP相对状态估计AF 
